...
class AdminAttendantCreate(BaseModel):
    """Administrator-only request for provisioning an operator."""
...
class AttendantFacilityUpdate(BaseModel):
    """Administrator-only request for moving an operator."""

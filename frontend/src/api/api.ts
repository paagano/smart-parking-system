...
export interface AIChatRequest {
   ...
   * The SmartPark chatbot obtains it through the
   * browser Geolocation API when permission is granted.
   */
...
export const aiApi = {
   ...
   * POST /ai/chat
   *
   * Location is optional because not every SmartPark question
   * requires the user's location.
   *
   * Examples:
   *
